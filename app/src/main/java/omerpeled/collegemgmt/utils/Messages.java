...
public class Messages {
  ...
  public static final String MSG_PROMPT_EMPTY_TO_FINISH = ", or leave empty to finish";
  ...
  public static final String MSG_FAIL_ALREADY_HEAD = "%s is already the head of %s!";
  ...
  public static final String MSG_FAIL_INVALID_COMMITTEE_MEMBER = "%s cannot be added to this committee! (member degree must be %s)";
  ...
  public static final String MSG_MEMBER_DEGREE = "member degree";
  public static final String MSG_SALARY = "Salary";
  public static final String MSG_ARTICLE_COUNT = "Number of articles published";
  public static final String MSG_ARTICLE_NAME = "name of an article published";
