...
public class Messages {
  ...
  public static final String MSG_FAIL_EXISTS = "%s already exists!%n";
  public static final String MSG_FAIL_NOT_EXISTS = "%s doesn't exist!%n";
  ...
  public static final String MSG_FAIL_INVALID_COMMITTEE_HEAD = "%s cannot be a committee head! (degree must be %s or %s)%n";
  ...
  public static final String MSG_LECTURER_WITH_ID = MSG_LECTURER + " with ID ";
